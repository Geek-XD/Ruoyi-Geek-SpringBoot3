    ...
    public void initialize(String imageType) {
        ...
        try {
            ...
            CASETASK_IMAGE = ImageIO
                    .read(ReflectUtil.getResource("org/flowable/icons/caseTask.png", this.customClassLoader));
            ...
            CONDITIONAL_CATCH_IMAGE = ImageIO
                    .read(ReflectUtil.getResource("org/flowable/icons/conditional.png", this.customClassLoader));
            ...
            ESCALATION_THROW_IMAGE = ImageIO
                    .read(ReflectUtil.getResource("org/flowable/icons/escalation-throw.png", this.customClassLoader));
            ESCALATION_CATCH_IMAGE = ImageIO
                    .read(ReflectUtil.getResource("org/flowable/icons/escalation.png", this.customClassLoader));
