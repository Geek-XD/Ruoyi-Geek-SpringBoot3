...
CREATE TABLE sys_form (
    form_id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
COMMENT ON COLUMN sys_form.form_id IS '表单主键';
COMMENT ON COLUMN sys_form.form_name IS '表单名称';
COMMENT ON COLUMN sys_form.form_content IS '表单内容';
COMMENT ON COLUMN sys_form.create_time IS '创建时间';
COMMENT ON COLUMN sys_form.update_time IS '更新时间';
COMMENT ON COLUMN sys_form.create_by IS '创建人员';
COMMENT ON COLUMN sys_form.update_by IS '更新人员';
COMMENT ON COLUMN sys_form.remark IS '备注';
...
BEGIN
    ...
    INSERT INTO sys_menu (menu_name, parent_id, order_num, path, component, query, route_name, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
    VALUES ('表单配置', flowable_parent_id, 2, 'form', 'flowable/task/form/index', NULL, NULL, 1, 1, 'C', '0', '0', 'flowable:form:list', 'form', 'admin', '2021-03-30 22:55:12', 'admin', '2023-08-19 15:54:57', '')
    RETURNING menu_id INTO form_parent_id;

    INSERT INTO sys_menu (menu_name, parent_id, order_num, path, component, query, route_name, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
    VALUES ('新增', form_parent_id, 1, '', NULL, NULL, NULL, 1, 0, 'F', '0', '0', 'flowable:form:add', '#', 'admin', '2021-07-07 14:23:37', 'admin', '2023-08-16 09:17:38', '');
    INSERT INTO sys_menu (menu_name, parent_id, order_num, path, component, query, route_name, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
    VALUES ('删除', form_parent_id, 3, '', NULL, NULL, NULL, 1, 0, 'F', '0', '0', 'flowable:form:remove', '#', 'admin', '2021-07-07 14:24:10', '', NULL, '');
    INSERT INTO sys_menu (menu_name, parent_id, order_num, path, component, query, route_name, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
    VALUES ('编辑', form_parent_id, 2, '', NULL, NULL, NULL, 1, 0, 'F', '0', '0', 'flowable:form:edit', '#', 'admin', '2021-07-07 14:24:31', '', NULL, '');
    INSERT INTO sys_menu (menu_name, parent_id, order_num, path, component, query, route_name, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
    VALUES ('查询', form_parent_id, 4, '', NULL, NULL, NULL, 1, 0, 'F', '0', '0', 'flowable:form:query', '#', 'admin', '2021-07-08 14:05:22', '', NULL, '');
