...
CREATE TABLE form_data (
    ...
    form_version VARCHAR(10) NOT NULL COMMENT '表单版本（与模板表版本一致）',
...
INSERT INTO sys_menu (menu_name, parent_id, order_num, path, component, query,route_name, is_frame, is_cache, menu_type, visible, `status`, perms, icon, create_by, create_time, update_by, update_time, remark) VALUES ('表单管理', 0, 4, 'form', NULL, NULL, '',1, 0, 'M', '0', '0', NULL, 'documentation', 'admin', '2024-02-15 22:40:23', '', NULL, '');
...
-- 菜单 SQL
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('表单数据', @fileParentId, '1', 'data', 'form/data/index', 1, 0, 'C', '0', '0', 'form:data:list', '#', 'admin', sysdate(), '', null, '表单数据菜单');
